    ...
    /*
        public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
            ...
            if(token!=null&&token.length()>0){
                CookieUtil.setCookie(request,response,"token",token,WebConst.cookieExpire,false);
            ...
            if(token!=null) {
               /* String tokenInfo = StringUtils.substringBetween(token, ".");
                ...
                byte[] tokenBytes = base64UrlCodec.decode(tokenInfo);
          ...
          /*      Map map = getUserMapByToken(token);
            ...
            String userId=null;
                ...
                LoginRequire loginRequireAnno = handlerMethod.getMethodAnnotation(LoginRequire.class);
                if(loginRequireAnno!=null){
                    ...
                    if("success".equals(result)){
                        ...
                        if(loginRequireAnno.autoRedirect()){
